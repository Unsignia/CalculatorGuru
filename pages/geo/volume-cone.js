...
import { volumecone } from "./../../utils/geoformula.js";

export default function VolumeCone() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    var c = volumecone(missing, V, r, h);
  }
  ...
  return (
    <>
      <Title title="Volume of Cone" />
      <Header />

      <form className="w-3/4 mx-auto" onSubmit={handleSubmit}>
        <h1 className="py-8 text-center text-lg">Volume of Cone</h1>
        <div className="flex">
          <div className="w-3/4">
            <label
              htmlFor="names"
