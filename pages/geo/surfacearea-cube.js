...
import { surfaceareacube } from "./../../utils/geoformula.js";
...
export default function SurfaceAreaSphere() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    var c = surfaceareacube(missing, SA, a);
  }
  ...
  return (
    <>
      <Title title="Surface Area of Cube" />
      <Header />

      <form className="w-3/4 mx-auto" onSubmit={handleSubmit}>
        <h1 className="py-8 text-center text-lg">Surface Area of Cube</h1>
        <div className="flex">
          <div className="w-3/4">
            <label
              htmlFor="names"
        ...
        {missing == "SA" ? a2 : missing == "a" ? SA2 : null}
